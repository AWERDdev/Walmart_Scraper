                ...
                <div className="flex justify-center mt-10">
                    <div className="bg-white w-full max-w-[90%] md:max-w-[55vw] p-5 rounded-md shadow-lg">
                        ...
                        <div className="button-container grid justify-center">
                            <button className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition mt-5"onClick={Handlefunctions}>login</button>
                        </div>
                        <div className="links grid justify-center mt-5"><a href="http://localhost:5173/Signup">Already Have an Account</a></div>
                    </div>
                </div>
            </div>
        </main>
